...
<div class="result-filter">
    <?= GridView::widget([
        ...
        'options' => ['tag' => 'div', 'class' => 'result-filter'], // оборачиваем в div с Bootstrap CSS
        'emptyTextOptions' => ['tag' => 'p', 'class' => 'text-center text-danger'],
        'emptyText' => 'По вашому запиту нічого не знайдено',
        /*    'summary' => '<br/><p class="text-center text-muted">Всего найдено '.Announcements::sklonen( '{totalCount}', 'новость', 'новости', 'новостей').'</p>', // 127*/
